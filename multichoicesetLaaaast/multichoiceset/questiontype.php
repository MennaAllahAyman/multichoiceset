...
class qtype_multichoiceset extends question_type {
    ...
    public function save_question_options($question) {
        ...
        // added code 
        $options->num_of_wrong_answers = $question->num_of_wrong_answers;
        $options->minus_marks = $question->minus_marks;
    ...
    protected function initialise_question_instance(question_definition $question, $questiondata) {
        ...
        // added code 
        $question->num_of_wrong_answers = $questiondata->options->num_of_wrong_answers;
        $question->minus_marks = $questiondata->options->minus_marks;
    ...
    protected function get_num_correct_choices($questiondata) {
        ...
        foreach ($questiondata->options->answers as $answer) {
            if (!question_strategy::graded_state_for_fraction($answer->fraction)->is_incorrect()) {
                $numright += 1;
            }
        }
        return $numright;
