...
$string['num_of_wrong_answers'] = 'Number of wrong answers';
$string['num_of_wrong_answers_help'] = 'To enable minus module you need to specify positive number of wrong answers that when student mark them in quiz he will be minused the amount of specified marks below';

$string['minus_marks'] = 'Minus Marks';
$string['minus_marks_help'] = 'To enable minus module you need to specify positive number of minused marks per number of wrong answers specified above';

$string['MinusModule'] = 'Add minus module';
