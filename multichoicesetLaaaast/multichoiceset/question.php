...
require_once('StrategyPattern/all_or_nothing.php');
require_once('StrategyPattern/minus_module.php');
...
class qtype_multichoiceset_question extends qtype_multichoice_multi_question {
    ...
    public $num_of_wrong_answers;
    public $minus_marks;
    
    public $question_strategy;
    /**
     * Get the grade
     *
    ...
    public function grade_response(array $response) {
        ...
        $this->set_question_strategy($numwrong);
        
        $fraction = $this->question_strategy->grade_response($numwrong, $numcorrect == $numright, $this->minus_marks, $this->defaultmark);
    ...
    public function set_question_strategy($numwrong){
        if($this->num_of_wrong_answers != 0 && $numwrong >= $this->num_of_wrong_answers){
            $this->question_strategy = new minus_module(); 
        }else{
            $this->question_strategy = new all_or_nothing();
        }
    }
